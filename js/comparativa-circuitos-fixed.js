...
// ============================================
// FUNCIÓN PARA OBTENER NOMBRE REAL DEL CIRCUITO
// ============================================
...
function getCircuitName(circuitId) {
    ...
    if (circuitId.startsWith('circuit_')) {
        ...
        // Si aún no se encuentra, retornar un nombre más legible
...
function initCircuitComparison() {
    console.log('🔄 Inicializando comparativa de circuitos...');
    ...
    // Seleccionar todos por defecto (máximo 5)
...
// ============================================
// CALCULAR ESTADÍSTICAS DE CIRCUITOS
// ============================================
...
// ============================================
// RENDERIZAR GRÁFICA DE CIRCUITOS (LÍNEAS)
// ============================================
...
function renderCircuitChart(circuitsData, metric) {
    ...
    // Preparar datos según la métrica
    ...
    if (circuitsData.length > 1) {
        // Crear una sola línea que conecta todos los puntos
        const mainDataset = {
            label: label,
            data: data,
            borderColor: '#94a3b8',
        ...
        // Crear gráfica con línea base y puntos de colores
        ...
        // Para un solo circuito, usar gráfica de barras simple
        circuitComparisonChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: labels,
        ...
        return `
            <tr>
                ...
                <td class="metric-value ${positionClass}">
                    ${circuit.avgPosition > 0 ? circuit.avgPosition.toFixed(1) + 'º' : '-'}
                </td>
                <td class="metric-value positive">
                    ${circuit.bestPosition > 0 ? circuit.bestPosition + 'º' : '-'}
                </td>
...
// También actualizar cuando cambien los datos
